...
p_scatter <- plot_ly(
  ...
  name = 'scatter' # This is relevant for legends - see subplot section below
) |>
  layout(
...
p_subplot <- plotly::subplot(
  ...
  # nrows = 2,
  # heights = c(0.7, 0.3),  # e.g. First row: 70%, Second row: 30%
  shareX = FALSE,
  shareY = FALSE,
  titleX = TRUE,
  titleY = TRUE
...
```{r subplots}
# Creates a standalone HTML file of your figure
# You can remove the extra html dir of files that gets created
